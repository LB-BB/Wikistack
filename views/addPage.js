...
module.exports = () =>
  ...
  <for m method="POST" action="/wiki/">
    ...
    <div class="form-group">
      <label for="text-area" class="col-sm-2 control-label">Content</label>
      <div class="col-sm-10">
        <input id="text-area" name="text-area" type="text-area" class="form-control"/>
      </div>
    </div>
